...
{reg: [
  ...
  {bits: 1, name: 'Svnapot'},
  {bits: 1, name: 'Svpbmt'},
  {bits: 1, name: 'RV32_VMS'},
  {bits: 4, name: 'RV64_VMS'},
...
|8     |`two_stage`|WARL      | G-stage and two-stage translations
|9     |`Svnapot`  |WARL      | NAPOT translation contiguity
|10    |`Svpbmt`   |WARL      | Page-based memory types
|11    |`RV32_VMS` |WARL      | Page-based 32-bit virtual-memory system
|15:12 |`RV64_VMS` |WARL     a| RV64 virtual-memory system
[%header, cols="^1,1,4"]
!===
                                !Value  !Name      ! Description
                                !0      !`None`    ! No S/VS-stage translations
                                                     or protections
                                !8      !`Sv39`    ! Page-based 48-bit 
                                                     virtual-memory system 
                                !9      !`Sv48`    ! Page-based 48-bit 
                                                     virtual-memory system 
                                !10     !`Sv57`    ! Page-based 57-bit 
                                                     virtual-memory system 
!===
...
|47:24 |`reserved` |WPRI      | Reserved for standard use
...
|8    |`cqmf`  |RW1C      | If command-queue access lead to a memory fault then
                            ...
                            writing 1. 
|9    |`cmd_to`|RW1C      | If the execution of an command leads to a 
